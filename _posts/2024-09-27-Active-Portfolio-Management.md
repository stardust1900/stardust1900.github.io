...
让我们考虑任意一个组合P，记组合P的超额收益率（excess return）为$r_P$，市场组合M的超额收益率为$r_M$。超额收益率是收益率减去同期无风险资产的收益率。我们定义组合P的贝塔为：$$\beta_P = \frac{Cov(r_P,r_M)}{Var(r_M)}$$
...
<blockquote style="background-color: lightgrey; color: darkblue; padding: 10px;"> 
