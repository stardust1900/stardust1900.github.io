...
我只写了依据话：使用 Vite 创建一个纯前端相册，读取albums目录下以YYYY-MM-dd-开头的文件夹里的图片，生成缩略图，图片详情也展示Exif信息...
...
让后在EdgeOne Pages里设置。找不到的，直接用这个链接[https://console.tencentcloud.com/edgeone/pages](https://console.tencentcloud.com/edgeone/pages)
...
部署完成需要配置域名。因为我的域名没有备案，加速区域智能选全球可用区（不含中国大陆）。
