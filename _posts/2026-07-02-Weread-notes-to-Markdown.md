...
kindle的读书笔记导出的是html格式，通过脚本可以很方便地转成markdown。我之前还发过转换的脚本-->[kindle笔记转成markdown](https://wangxuan.me/tech/2024/11/13/kindle-notes-to-markdown.html)
...
具体发布过程可以参考这个：[用Gitee和EdgeOne Pages搭建支持外链的免费相册](https://wangxuan.me/tech/2026/05/28/Free-Album-with-Gitee-and-EdgeOne-Pages.html)